<div class="col-12 mb-5">
    <div class="activity-message mb-2">
        <a href="user-profile.html" class="user-tag">@john_smith</a> has posted on an event you joined.
    </div>
    ...
    <div class="card container-fluid hover-shadow" tabindex="-1">
        <div class="row post-card-header align-items-center">
            <div class="col-12">
                <a href="event.html">
                    <h5 class="mb-0 event-title px-0 px-md-3">NOS Primavera Sound 2019</h5>
                </a>
            </div>
        </div>
