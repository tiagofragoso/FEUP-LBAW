        ...
        <div class="card col-12 col-lg-9 mb-4 hover-shadow">
            <div class="row">
                ...
                <div
                    ...
                    <button type="button" data-toggle="collapse" data-target="#comments{{$thread->id}}"
                    ...
                    <div class="col-12 col-md-10 d-flex flex-row align-items-center">
                        ...
                        <form class="position-relative w-100" action="#">
                            <textarea class="form-control position-relative w-100 pr-5" rows="1"
                                placeholder="Reply to this thread..." style="resize: none"></textarea>
                            <div
