...
<script defer type="text/javascript" src="/js/comments.js"> </script>
@endsection
				...
				<div class="container-fluid mt-3">
					<div class="row justify-content-between">
						...
						<div class="col-12 col-sm-3">
							...
							@else
							<button type="submit" class="btn btn-outline-primary w-100 join-btn joined"
								data-id="{{$event->id}}"> Joined </button>
							@endif
						</div>
					</div>
					<hr>
					<div class="row mb-3 justify-content-between">
						...
						<div class="col-3">
							<p class="card-subtitle text-muted text-right" id="participants">{{$event->participants}} <i
									class="mr-1 fas fa-users"></i></p>
						</div>
					</div>
					<div class="row mb-3 justify-content-between">
						<div class="col-8">
					...
					<div class="row artists-wrapper">
						...
						<a href="{{ url('/users/'.$artist->id) }}"
							...
							<img src="{{asset('assets/user.svg')}}"
								class="rounded-circle rounded-circle border border-light" width="40" />
								...
								<div class="row justify-content-center mb-4">
									<ul class="col-12 col-md-9 list-group list-group-flush">
										...
										<li class="list-group-item">
											...
											data-toggle="collapse" href="#collapse{{$question->id}}" role="button"
									...
									<ul class="col-12 col-md-9 list-group list-group-flush">
										...
										<li class="list-group-item">
											<a class="pl-0 text-decoration-none qa-question dropdown-toggle"
												...
												data-target="#question{{$question->id}}" aria-expanded="false"
